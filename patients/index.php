...
<button style="padding:8px 14px;background:#1e88e5;color:#fff;border:none;border-radius:4px;">
Filter
</button>

<a href="?page=patients"
   style="padding:8px 14px;background:#777;color:#fff;border-radius:4px;text-decoration:none;">
Reset
</a>
</form>

<a href="patients/create.php"
   style="display:inline-block;margin-bottom:15px;padding:10px 16px;
   background:#1e88e5;color:#fff;border-radius:4px;text-decoration:none;">
+ Register Patient
</a>
...
<?php if (!$patients): ?>
<tr><td colspan="4" style="padding:15px;text-align:center;">No records found.</td></tr>
...
<td style="text-align:center;">
<a href="view.php?id=<?= $p['patient_id'] ?>">View</a> |
<a href="edit.php?id=<?= $p['patient_id'] ?>">Edit</a>
</td>
</tr>
